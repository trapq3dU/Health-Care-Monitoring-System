    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
		...
		<?php
			...
			$sql = "SELECT * FROM patients WHERE uid='$userprofile'";
			...
			if($result-> num_rows > 0)
			{
				...
				{
					echo "<tr><td>".$row["pid"]."</td><td>".$row["uid"]."</td><td>".$row["pfname"]."</td><td>".$row["pmname"]."</td><td>".$row["plname"]."</td><td>".$row["dob"]."</td><td>".$row["gender"]."</td><td>".$row["age"]."</td><td>".$row["poccupation"]."</td><td>".$row["din"]."</td><td>".$row["dout"]."</td><td>".$row["under"]."</td><td>".$row["disease"]."</td><tr>" ;
				}
				echo "</table>";
			}
			else
			{
				echo "Nothing there to show you";
			}
