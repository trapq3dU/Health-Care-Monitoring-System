...
//by verifying the data from admins table
	...
	if(isset($_POST['submit']))
	{
		$user = $_POST['username'];
		$pass = $_POST['password'];
		$query = "SELECT * FROM admins WHERE Username='$user' && Password='$pass'";
							...
							<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">						
								<div class="panel panel-skin">
									<div class="panel-heading">
										<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Login below <small>(Admins Only)</small></h3>
									</div>
									<div class="panel-body">

										
									<!--This is login form for admins-->

									<form method="POST" role="form" class="lead">
										<div class="row">											
										...
										<input type="submit" name="submit" value="Login" class="btn btn-skin btn-block btn-lg">										
										<p class="lead-footer">*All fields are required</p>
										<p class="lead-footer">Password is NOT case sensitive</p>									
									</form>
								</div>
							</div>						
						</div>
