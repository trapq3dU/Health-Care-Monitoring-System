...
<section>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      $sql = "SELECT * FROM patients WHERE pfname='$ppi' && pmname='$ppj'&& plname='$ppk'&& dob='$ppl'";
      ...
      if($result-> num_rows > 0)
      {
        ...
        {
          echo "<tr><td>".$row["pid"]."</td><td>".$row["uid"]."</td><td>".$row["pfname"]."</td><td>".$row["pmname"]."</td><td>".$row["plname"]."</td><td>".$row["dob"]."</td><td>".$row["gender"]."</td><td>".$row["age"]."</td><td>".$row["poccupation"]."</td><td>".$row["din"]."</td><td>".$row["dout"]."</td><td>".$row["under"]."</td><td>".$row["disease"]."</td><td>".$row["mdcn1"]."</td><tr>" ;
        }
        echo "</table>";
      }
      else
